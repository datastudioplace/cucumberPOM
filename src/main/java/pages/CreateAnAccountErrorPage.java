...
public class CreateAnAccountErrorPage extends BasePage{
	
	public CreateAnAccountErrorPage() throws IOException {
		super();
	...
	// MEDTHODS
	public CreateAnAccountErrorPage clickTitleMr() throws Exception {
		Thread.sleep(3000);
		...
		for (int i = 0; i < count; i++) 
			...
			driver.findElements(By.name("id_gender")).get(0).click();
			   ...
			   return new CreateAnAccountErrorPage();
	...
	public CreateAnAccountErrorPage getContactUsPage(String Url) throws IOException {
		getDriver().get(Url);
		return new CreateAnAccountErrorPage();
	}
	public CreateAnAccountErrorPage getCreateAnAccountText_createAnAccount(String arg1) throws Exception {
	...
	public CreateAnAccountErrorPage enterFName(String Url) throws Exception {
		createAnAccountPage.sendKeysToWebElement(textfield_FirstNamePersonalInfo, Url);
		return new CreateAnAccountErrorPage();
	}
	
	public CreateAnAccountErrorPage enterLName(String Url) throws Exception {
		createAnAccountPage.sendKeysToWebElement(textfield_LastNamePersonalInfo, Url);
		return new CreateAnAccountErrorPage();
	}
	
	public CreateAnAccountErrorPage enterPassword(String Url) throws Exception {
		createAnAccountPage.sendKeysToWebElement(textfield_Password, Url);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage getconfirmEmailaddress(String arg1) throws Exception {
		createAnAccountPage.textfield_Emailconfirm.isDisplayed();
		return new CreateAnAccountErrorPage();
	}
	
	public CreateAnAccountErrorPage gettext_YourPersonalInformationSection(String arg1) throws Exception {
	...
	public CreateAnAccountErrorPage gettext_YourAddressSection(String arg1) throws Exception {
	...
	public CreateAnAccountErrorPage enterDayDOB(String arg1) throws Exception {

		new Select(driver.findElement(By.xpath("//select[@id='days']"))).selectByValue(arg1);
		return new CreateAnAccountErrorPage();
	}
	
	public CreateAnAccountErrorPage enterMonthDOB(String arg1) throws Exception {
	...
	public CreateAnAccountErrorPage enterYearDOB(String arg1) throws Exception {
		// basePage.WaitUntilWebElementIsVisible(DropBox_YearDOB);
		// DropBox_YearDOB.click();
		new Select(driver.findElement(By.xpath("//select[@id='years']"))).selectByValue(arg1);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage clickSignupNewsletterCheckbox() throws Exception {
		WaitUntilWebElementIsVisible(TickButton_SignupNewsletter);
		TickButton_SignupNewsletter.click();
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage clickSignupReceiveSpecialOffersCheckbox() throws Exception {
		WaitUntilWebElementIsVisible(TickButton_SignupNewsletter);
		TickButton_ReceiveSpecialOffers.click();
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage enterCompanyName(String arg1) throws Exception {
		createAnAccountPage.textfield_CompanyName.isDisplayed();
		basePage.sendKeysToWebElement(textfield_CompanyName, arg1);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage enterFirstAddress(String arg1) throws Exception {
		createAnAccountPage.textfield_Address.isDisplayed();
		basePage.sendKeysToWebElement(textfield_Address, arg1);
		return new CreateAnAccountErrorPage();
	}
	
	public CreateAnAccountErrorPage getConfirmationAddress_RedWarningAddresstext(String arg1) throws Exception {
	...
	public CreateAnAccountErrorPage enterSecondAddress(String arg1) throws Exception {
		createAnAccountPage.textfield_Address2.isDisplayed();
		basePage.sendKeysToWebElement(textfield_Address2, arg1);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage enterCityName(String arg1) throws Exception {
		basePage.sendKeysToWebElement(textfield_City, arg1);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage selectStateDropBox(String arg1) throws Exception {
		Select drpCountry = new Select(DropBox_State);
		drpCountry.selectByVisibleText(arg1);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage enterZiporPostCode(String arg1) throws Exception {
		basePage.sendKeysToWebElement(textfield_ZipPostalCode, arg1);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage selectCountryDropBox(String arg1) throws Exception {

		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage enterHomePhoneNumber(String arg1) throws Exception {
		basePage.sendKeysToWebElement(textfield_HomePhone, arg1);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage enterMobilePhoneNumber(String arg1) throws Exception {
		basePage.sendKeysToWebElement(textfield_MobilePhone, arg1);
		return new CreateAnAccountErrorPage();
	}
	
	public CreateAnAccountErrorPage getConfirmationAddress_RedWarningtextRED_YouMustRegisterAtLeastOnePhoneNumberText(String arg1) throws Exception {
	...
	public CreateAnAccountErrorPage enterAdditionalInfo(String arg1) throws Exception {
		basePage.sendKeysToWebElement(textfield_AdditionalInfo, arg1);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage enterAliasAddressRef(String arg1) throws Exception {
		basePage.sendKeysToWebElement(textfield_AssignAddressAlias, arg1);
		return new CreateAnAccountErrorPage();
	}

	public CreateAnAccountErrorPage clickRegisterButton() throws Exception {
